...
\input{motivaione.tex}

\input{intro.tex} % Introduzione
\input{cap1.tex} % BioInformatica
\input{cap1-2.tex} % Proteine
\input{cap2.tex} % Predizione della struttura delle proteine
\input{cap3.tex} % Alphafold
\input{cap4.tex} % Sperimentazione
\input{cap5.tex} % Protein Engineering e campi applicativi
\input{conclusioni.tex} % Conclusioni
